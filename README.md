...
Para facilitar um pouco mais do conhecimento da regra de negócio, trabalhei com a mesma aplicação do desafio anterior: uma aplicação para gerenciar tarefas (ou *todos*) mas com algumas mudanças: **[Desafio 1 - Conceitos do Node.js](https://github.com/thiagokrathos/desafios-do-nodejs)**
